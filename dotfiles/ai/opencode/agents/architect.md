...
- Keep architectural judgment in this agent. Use `bulk-reader` for broad context from large files;
  pass exact paths and one narrow question, never pasted source. Use `code-writer` only in
